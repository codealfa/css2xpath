...
/**
 * @implements IteratorAggregate<int, ClassSelector>
 */
final class ClassCollection implements Countable, IteratorAggregate
{
    ...
    public function add(ClassSelector $selector): void
    {
    ...
    /**
     * @return Traversable<int, ClassSelector>
     */
